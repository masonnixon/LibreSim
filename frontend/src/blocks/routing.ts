...
export const routingBlocks: BlockDefinition[] = [
  ...
  },
  {
    ...
    category: 'routing',
    name: 'Reshape',
    description: 'Change signal dimensions',
    inputs: [{ name: 'in', dataType: 'double', dimensions: [1] }],
    outputs: [{ name: 'out', dataType: 'double', dimensions: [1] }],
    parameters: [
      {
        ...
        options: [
          { value: '1-D array', label: '1-D array' },
          { value: 'Column vector', label: 'Column vector' },
      ...
      },
      {
        ...
        description: 'Custom output dimensions (e.g., [2,3])',
      },
    ],
    icon: '[ ]',
  },
  {
    ...
    category: 'routing',
    name: 'Selector',
    description: 'Select elements from vector/matrix',
    inputs: [{ name: 'in', dataType: 'double', dimensions: [1] }],
    outputs: [{ name: 'out', dataType: 'double', dimensions: [1] }],
    parameters: [
      {
        ...
        label: 'Index Mode',
        options: [
          { value: 'One-based', label: 'One-based' },
      ...
      },
      {
        ...
        default: '[1]',
        label: 'Indices',
        description: 'Elements to select (e.g., [1,3,5])',
      },
    ],
    icon: '[i]',
  },
  {
    ...
    category: 'routing',
    name: 'Concatenate',
    description: 'Concatenate signals into array',
    inputs: [
      { name: 'in1', dataType: 'double', dimensions: [1] },
      { name: 'in2', dataType: 'double', dimensions: [1] },
    ],
    ...
    parameters: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: 'Multidimensional array', label: 'Multidimensional array' },
        ],
      },
    ],
    icon: '++',
  },
  {
    ...
    description: 'Convert signal data type',
    inputs: [{ name: 'in', dataType: 'double', dimensions: [1] }],
    outputs: [{ name: 'out', dataType: 'double', dimensions: [1] }],
    parameters: [
      {
  ...
  },
  {
    ...
    category: 'routing',
    name: 'Ground',
    description: 'Provide zero signal',
    inputs: [],
    outputs: [{ name: 'out', dataType: 'double', dimensions: [1] }],
    parameters: [],
    icon: '⏚',
