...
def anti_windup_pid_template(block: BlockInfo, struct_name: str) -> str:
    ...
    upper = block.parameters.get("upperLimit", block.parameters.get("upper_limit", None))
    lower = block.parameters.get("lowerLimit", block.parameters.get("lower_limit", None))
