    ...
    def _register_math(self):
        ...
        blocks = [
            ...
            },
            {
                ...
                "category": "math",
                "name": "Math Function",
                "description": "Mathematical function (exp, log, sqrt, etc.)",
                "inputs": [{"name": "in", "dataType": "double", "dimensions": [1]}],
                "outputs": [{"name": "out", "dataType": "double", "dimensions": [1]}],
                "parameters": [
                    {"name": "function", "type": "select", "default": "exp", "label": "Function"},
                    {"name": "exponent", "type": "number", "default": 2, "label": "Exponent"},
                ],
                "icon": "f(u)",
            },
            {
                ...
                "category": "math",
                "name": "Trigonometric",
                "description": "Trigonometric function (sin, cos, tan, etc.)",
                "inputs": [{"name": "in", "dataType": "double", "dimensions": [1]}],
                "outputs": [{"name": "out", "dataType": "double", "dimensions": [1]}],
                "parameters": [
                    {"name": "function", "type": "select", "default": "sin", "label": "Function"},
                ],
                "icon": "sin",
            },
            {
            ...
            },
            {
                ...
                "outputs": [{"name": "out", "dataType": "double", "dimensions": [1]}],
                "parameters": [
                    {"name": "function", "type": "select", "default": "min", "label": "Function"},
                ],
                "icon": "↕",
            },
        ]
