...
BLOCK_TYPE_MAP: dict[str, type[Block]] = {
    ...
    "matrix_zeros": MatrixZeros,
    "matrix_diagonal": MatrixDiagonal,
    "matrix_reshape": MatrixReshape,
    "selector": Selector,
...
PARAM_MAP: dict[str, dict[str, str]] = {
    ...
    "matrix_transpose": {},
    "matrix_inverse": {},
    "matrix_identity": {"size": "n"},
    "matrix_zeros": {"rows": "rows", "cols": "cols"},
    "matrix_diagonal": {"values": "values"},
    "matrix_reshape": {"rows": "rows", "cols": "cols"},
