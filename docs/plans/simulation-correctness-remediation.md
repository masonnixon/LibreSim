...
| LS-10 | in progress; FAC-9 Phases 0-4 complete | `e536fb4`, `16c97ab`, `f3051b9`, `9d4531a`, `a450f20`, `ec15bb1`, `e33a9fd` | Instance-owned context, block/native `Sim` ownership, runner lifecycle isolation, deterministic concurrent stepping, atomic per-runner operation/handoff ownership, and built-in context migration are complete. Versioned snapshot work is next. |
