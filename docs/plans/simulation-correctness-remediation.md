...
| LS-10 | in progress; FAC-9 Phases 0-3 complete | `e536fb4`, `16c97ab`, `f3051b9`, `9d4531a`, `a450f20`, `ec15bb1` | Instance-owned context, block/native `Sim` ownership, runner lifecycle isolation, deterministic concurrent stepping, and atomic per-runner operation/handoff ownership are complete. Built-in block migration is next. |
