...
| FAC-10 | complete | `6e7f690`, `15b54a9` | From a clean detached checkout of `6e7f690`, the full matrix passed: backend 2,185 passed/1 skipped; numerical subset 33 passed; frontend 664 passed; Ruff, mypy across 138 files, ESLint, and TypeScript clean; generated validator 156/156 with zero simulation, build, run, or output-validation failures and a byte-identical report. Tool versions and the verified LS-1 through LS-10 hash ledger are recorded in `.claude/docs/fable-audit-remediation-status-2026-07-16.md`; the 2026-07-10 status remains unchanged. The three completed plans were archived under `docs/plans/completed/`, while the independent refactoring and compatibility-facade deprecation plans remain active. |
