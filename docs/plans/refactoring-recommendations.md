...
- `docs/reports/codegen-validation-report.md` — generated by `scripts/validate_codegen.py`, is a CI artifact
...
`docs/guides/software-quality.md` is the authoritative quality guide; it complements the testing commands in `docs/guides/testing.md`.

### 29. Move planning docs out of `codegen_verification/`

The cross-language report is retained at `docs/reports/archive/codegen-cross-language-consistency-2026-01-21.md`; its improvement-plan outcomes are merged into that report.
