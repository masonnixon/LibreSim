...
| FAC-9 | in progress; Phases 0-1 complete | `e536fb4`, `16c97ab`, `f3051b9` | 2026-07-16 maintainer selected and approved concurrent simulations. Phase 0 reproduced deterministic solver/clock cross-talk for alternating adapters and runners. Phase 1 added the instance-owned `SimContext`, compatibility facade, adapter activation/ownership, and isolation regressions. Docker verification passed 2,121 tests with 1 skip; Ruff and mypy passed across 136 source files. Phase 2 block/native-`Sim` ownership is next. |
