...
`16c97ab`, and authorized production work after the pre-FAC-9 checkpoint. Phases 0-5
are complete through `959e8aa`; session-addressed API concurrency is next.
